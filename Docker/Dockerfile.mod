...
ARG distcchosts=''
ARG concurrency="12"
ARG qtversion="5.12.8"
ARG OZW_VERSION=3743db1f162c163dcfb99e3c1d9b102a33bc4dfd
ARG QTMQTT_VERSION="5.12.8"
ARG QTWEBSOCKETS_VERSION="5.12.8"
...
LABEL maintainer="firstof9@gmail.com"
...
RUN git clone https://github.com/firstof9/open-zwave \
	&& cd open-zwave \
...
COPY /usr/share/qt5/qt-openzwavedatabase.rcc /opt/qt/${qtversion}/
